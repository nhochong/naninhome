<?php
class fridominimal_setup_sidebar {
    ...
    public function init_sidebar(){
        register_sidebar(array(
            'name'          => esc_html__('Blog Sidebar', 'frido'),
            'id'            => 'sidebar-blog',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on blog posts and archive pages.', 'frido'),
...
return new fridominimal_setup_sidebar();