...
if (!class_exists( "OSF_Nav_walker" )){
    class OSF_Nav_walker extends Walker_Nav_Menu {
        private $css_inline;
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
            ...
            if (isset( $item->text_customize ) && !empty( $item->text_customize )){
                switch ($item->text_customize) {
                    case 'text_new':
                        $text_customize = esc_html__( 'New', 'fridominimal-core' );
                        break;
                    case 'text_hot':
                        $text_customize = esc_html__( 'Hot', 'fridominimal-core' );
                        break;
                    case 'text_featured':
                        $text_customize = esc_html__( 'Featured', 'fridominimal-core' );
                        break;
                    default:
                        $text_customize = '';
                        break;
