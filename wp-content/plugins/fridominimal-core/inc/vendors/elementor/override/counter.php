...
class OSF_Elementor_Counter extends Widget_Counter
{
    ...
    {
        return __('Counter', 'fridominimal-core');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'section_counter',
            [
                'label' => __('Counter', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'starting_number',
            [
                'label' => __('Starting Number', 'fridominimal-core'),
        ...
        $this->add_control(
            'ending_number',
            [
                'label' => __('Ending Number', 'fridominimal-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => 100,
            ]
        );
        ...
        $this->add_control(
            'prefix',
            [
                'label' => __('Number Prefix', 'fridominimal-core'),
        ...
        $this->add_control(
            'suffix',
            [
                'label' => __('Number Suffix', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'placeholder' => __('Plus', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'show_icon',
            [
                'label' => __('Show Icon', 'fridominimal-core'),
        ...
        $this->add_control(
            'icon_select',
            [
                'label' => __('Icon select', 'fridominimal-core'),
                'type' => Controls_Manager::SELECT,
                'default' => 'use_icon',
                'options' => [
                    'use_icon' => __('Use Icon', 'fridominimal-core'),
                    'use_image' => __('Use Image', 'fridominimal-core'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label' => __('Thousand Separator', 'fridominimal-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'label_on' => __('Show', 'fridominimal-core'),
                'label_off' => __('Hide', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Separator', 'fridominimal-core'),
                'type' => Controls_Manager::SELECT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Cool Number', 'fridominimal-core'),
                'placeholder' => __('Cool Number', 'fridominimal-core'),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            'section_number',
            [
                'label' => __('Number', 'fridominimal-core'),
