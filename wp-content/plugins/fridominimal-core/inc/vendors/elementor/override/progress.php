...
class OSF_Widget_Progress extends Widget_Progress {
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_progress',
			[
				'label' => __( 'Progress Bar', 'fridominimal-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'My Skill', 'fridominimal-core' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'' => __( 'Default', 'fridominimal-core' ),
					'info' => __( 'Info', 'fridominimal-core' ),
					'success' => __( 'Success', 'fridominimal-core' ),
					'warning' => __( 'Warning', 'fridominimal-core' ),
					'danger' => __( 'Danger', 'fridominimal-core' ),
				],
			]
		);
		...
		$this->add_control(
			'percent',
			[
				'label' => __( 'Percentage', 'fridominimal-core' ),
        ...
        $this->add_control(
            'enable_text_outside',
            [
                'label'     => __('Enable Outside', 'fridominimal-core'),
                'type'      => \Elementor\Controls_Manager::SWITCHER,
                'label_on'  => __('Yes', 'fridominimal-core'),
                'label_off' => __('No', 'fridominimal-core'),
                //                'condition' => [
                //                    'layout' => 'carousel',
                //                ],
            ]
		...
		$this->add_control( 'display_percentage', [
			'label' => __( 'Display Percentage', 'fridominimal-core' ),
			'type' => Controls_Manager::SELECT,
			'default' => 'show',
			'options' => [
				'show' => __( 'Show', 'fridominimal-core' ),
				'hide' => __( 'Hide', 'fridominimal-core' ),
			],
		] );
        ...
        $this->add_control(
            'inner_text',
            [
                'label' => __( 'Inner Text', 'fridominimal-core' ),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __( 'e.g. Web Designer', 'fridominimal-core' ),
                'default' => __( 'Web Designer', 'fridominimal-core' ),
                'label_block' => true,
                'condition' => [
                    'enable_text_outside' => '',
                ],
		...
		$this->add_control(
			'bar_inline_color',
			[
				'label' => __( 'Inner Text Color', 'fridominimal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Title Style', 'fridominimal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
