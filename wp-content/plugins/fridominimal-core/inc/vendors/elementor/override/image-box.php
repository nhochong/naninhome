...
class OSF_Widget_Image_Box extends Widget_Image_Box {
    ...
    public function get_title() {
        return __('Image Box', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_image',
            [
                'label' => __('Image Box', 'fridominimal-core'),
            ]
        );
...
//                    'framed' => __( 'Framed', 'elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your sub-title', 'fridominimal-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Hover Wrapper Animation', 'fridominimal-core' ),
        ...
        $this->add_control(
            'position',
            [
                'label'        => __('Image Position', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('SVG Options', 'fridominimal-core'),
        ...
        $this->add_responsive_control(
            'svg_size',
            [
                'label'          => __('SVG Size', 'fridominimal-core'),
                'type'           => Controls_Manager::SLIDER,
                'default'        => [
                    'size' => 46,
                    'unit' => 'px',
        ...
        $this->add_control(
            'svg_color',
            [
                'label'     => __('SVG Color', 'fridominimal-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Box View', 'fridominimal-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'view_bg',
            [
                'label'     => __('Box View Background', 'fridominimal-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'framed_color',
            [
                'label'     => __('Framed Color', 'fridominimal-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => __('Color Hover (Wrapper)', 'fridominimal-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
