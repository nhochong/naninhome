...
class OSF_Widget_Toggle extends Widget_Toggle {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Toggle Items', 'fridominimal-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title' => __( 'Toggle #1', 'fridominimal-core' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'fridominimal-core' ),
					],
					[
						'tab_title' => __( 'Toggle #2', 'fridominimal-core' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'fridominimal-core' ),
					],
				],
				'fields' => [
					[
						...
						'default' => __( 'Toggle Title' , 'fridominimal-core' ),
						'label_block' => true,
					],
					[
						'name' => 'tab_content',
						...
						'default' => __( 'Toggle Content', 'fridominimal-core' ),
						'show_label' => false,
					],
				],
		...
		$this->add_control(
			'icon_active',
			[
				'label' => __( 'Active Icon', 'fridominimal-core' ),
				'type' => Controls_Manager::ICON,
		...
		$this->add_control(
			'show_item_first',
			[
				'label' => __( 'Show Item First', 'fridominimal-core' ),
        ...
        $this->add_control(
            'event_type',
            [
                'label' => __( 'Event Type', 'fridominimal-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'toggle' => 'Toggle',
                    'accordion' => 'Accordion'
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => __( 'Start', 'fridominimal-core' ),
						'icon' => 'eicon-h-align-left',
					],
					'right' => [
						'title' => __( 'End', 'fridominimal-core' ),
