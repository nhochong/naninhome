...
class OSF_Elementor_ContactForm7 extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Contact Form', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Contact form', 'fridominimal-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_lable_style',
            [
                'label' => __( 'Lable', 'fridominimal-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Placeholder Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
