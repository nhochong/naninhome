...
class OSF_Elementor_Text_Carousel extends OSF_Elementor_Carousel_Base{
    ...
    public function get_title() {
        return __('Opal Text Carousel', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'contents',
            [
                'label'       => __('Content Item', 'fridominimal-core'),
                ...
                'fields'      => [
                    [
                        ...
                        'default' => __( 'Title', 'fridominimal-core' ),
                        'label_block' => true,
                    ],
                    [
                        'name' => 'subtitle',
                        ...
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Sub Title', 'fridominimal-core' ),
                        'label_block' => true,
                    ],
                    [
                        'name'        => 'content',
        ...
        $this->add_control(
            'header_size',
            [
                'label' => __( 'HTML Tag', 'fridominimal-core' ),
        ...
        $this->add_control(
            'subtitle_position',
            [
                'label' => __( 'Subtitle Position', 'fridominimal-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'after',
                'options' => [
                    'after' => __( 'After Title', 'fridominimal-core' ),
                    'before' => __( 'Before Title', 'fridominimal-core' ),
                ],
            ]
        );
