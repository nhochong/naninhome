...
class OSF_Elementor_Google_Map extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Google Maps', 'fridominimal-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_map',
            array(
                'label' => __( 'Map', 'fridominimal-core' )
            )
        );
        ...
        $this->add_control(
            'latitude',
            array(
                'label'   => __('Latitude', 'fridominimal-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '21.030497',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'fridominimal-core' ), 'https://www.google.com/maps')
            )
        ...
        $this->add_control(
            'longitude',
            array(
                'label'   => __('Longitude', 'fridominimal-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '105.852510',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Ex: 21.030497, 105.852510. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'fridominimal-core' ), 'https://www.google.com/maps')
            )
        );
        ...
        $this->add_responsive_control(
            'height',
            [
                'label' => __( 'Height', 'fridominimal-core' ),
                ...
                'default' => [ 'size' => 500 ],
                'description' => esc_html__( 'Height of map.(px)', 'fridominimal-core' ),
                'selectors' => [
        ...
        $this->add_control(
            'zoom',
            [
                'label' => __( 'Zoom Level', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_control(
            'prevent_scroll',
            [
                'label' => __( 'Prevent Scroll', 'fridominimal-core' ),
        ...
        $this->start_controls_section(
            'section_style_map',
            [
                'label' => __( 'Map Style', 'fridominimal-core' ),
        ...
        $this->add_control(
            'style',
            [
                'label' => __('Select Style', 'fridominimal-core'),
        ...
        $this->add_control(
            'all',
            [
                'label' => __( 'All Color', 'fridominimal-core' ),
        ...
        $this->add_control(
            'water_color',
            [
                'label' => __( 'Water Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'water_lightness',
            [
                'label' => __( 'Water Lightness', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            'landscape_color',
            [
                'label' => __( 'Landscape Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'landscape_lightness',
            [
                'label' => __( 'Landscape Lightness', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Lightness', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'poi_color',
            [
                'label' => __( 'Poi Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'poi_lightness',
            [
                'label' => __( 'Poi Lightness', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'road_color',
            [
                'label' => __( 'Road Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'road_lightness',
            [
                'label' => __( 'Road Lightness', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'transit_color',
            [
                'label' => __( 'Transit Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
        ...
        $this->add_control(
            'transit_lightness',
            [
                'label' => __( 'Transit Lightness', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
    ...
    private function data_style_title(){
        return array(
            ...
            'ultra_light' => __('Ultra Light', 'fridominimal-core'),
            'shades_of_grey' => __('Shades of Grey', 'fridominimal-core'),
            'blue_water' => __('Blue Water', 'fridominimal-core'),
            'light_grey_and_blue' => __('Light Grey and Blue', 'fridominimal-core'),
            'farma_gray' => __('Farma Gray', 'fridominimal-core'),
            'community' => __('Community', 'fridominimal-core'),
            'chilled' => __('Chilled', 'fridominimal-core'),
            'customize' => __('Customize', 'fridominimal-core')
