...
class OSF_Elementor_Button_Contact_Form extends  Widget_Button {
    ...
    public function get_title() {
        return __('Opal Button Contact Form 7', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        ...
        $contact_forms[''] = __('Please select form', 'fridominimal-core');
        if ($cf7) {
            foreach ($cf7 as $cform) {
                $contact_forms[$cform->ID] = $cform->post_title;
            }
        } else {
            $contact_forms[0] = __('No contact forms found', 'fridominimal-core');
        }

        $this->add_control(
            'cf_id',
            [
                'label'   => __('Select contact form', 'fridominimal-core'),
        ...
        $this->add_control(
            'form_name',
            [
                'label' => __( 'Form name', 'fridominimal-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Request A Call Back', 'fridominimal-core' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Free consultation', 'fridominimal-core' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_section(
            'section_form_style',
            [
                'label' => __( 'Form Style', 'fridominimal-core' ),
            ...
            $this->add_control(
                'heading_color',
                [
                    'label'     => __('Heading Color', 'fridominimal-core'),
                    'type'      => Controls_Manager::COLOR,
                    'scheme'    => [
                        'type'  => Scheme_Color::get_type(),
        ...
        $this->add_responsive_control(
            'heading_margin',
            [
                'label' => __( 'Headhing Margin', 'fridominimal-core' ),
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label'     => __('Sub title Color', 'fridominimal-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1,
        ...
        $this->add_responsive_control(
            'subtitle_margin',
            [
                'label' => __( 'Subtitle Margin', 'fridominimal-core' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
