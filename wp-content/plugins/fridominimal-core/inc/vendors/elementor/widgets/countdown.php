...
class OSF_Elementor_Countdown extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Countdown', 'fridominimal-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => __( 'Countdown', 'fridominimal-core' ),
            ]
        );
        ...
        $this->add_control(
            'due_date',
            [
                'label' => __( 'Due Date', 'fridominimal-core' ),
                'type' => Controls_Manager::DATE_TIME,
                'default' => date( 'Y-m-d H:i', strtotime( '+1 month' ) + ( get_option( 'gmt_offset' ) * HOUR_IN_SECONDS ) ),
                /* translators: %s: Time zone. */
                'description' => sprintf( __( 'Date set according to your timezone: %s.', 'fridominimal-core' ), Utils::get_timezone_string() ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'block' => __( 'Block', 'fridominimal-core' ),
                    'inline' => __( 'Inline', 'fridominimal-core' ),
                ],
                'default' => 'block',
        ...
        $this->add_control(
            'show_days',
            [
                'label' => __( 'Days', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'fridominimal-core' ),
                'label_off' => __( 'Hide', 'fridominimal-core' ),
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_hours',
            [
                'label' => __( 'Hours', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'fridominimal-core' ),
                'label_off' => __( 'Hide', 'fridominimal-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_minutes',
            [
                'label' => __( 'Minutes', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'fridominimal-core' ),
                'label_off' => __( 'Hide', 'fridominimal-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label' => __( 'Seconds', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'fridominimal-core' ),
                'label_off' => __( 'Hide', 'fridominimal-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label' => __( 'Show Label', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'fridominimal-core' ),
                'label_off' => __( 'Hide', 'fridominimal-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label' => __( 'Custom Label', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Days', 'fridominimal-core' ),
                'placeholder' => __( 'Days', 'fridominimal-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_days' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Hours', 'fridominimal-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Hours', 'fridominimal-core' ),
                'placeholder' => __( 'Hours', 'fridominimal-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_hours' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Minutes', 'fridominimal-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Minutes', 'fridominimal-core' ),
                'placeholder' => __( 'Minutes', 'fridominimal-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_minutes' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Seconds', 'fridominimal-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Seconds', 'fridominimal-core' ),
                'placeholder' => __( 'Seconds', 'fridominimal-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_seconds' => 'yes',
        ...
        $this->start_controls_section(
            'section_box_style',
            [
                'label' => __( 'Boxes', 'fridominimal-core' ),
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label' => __( 'Container Width', 'fridominimal-core' ),
        ...
        $this->add_control(
            'heading_digits',
            [
                'label' => __( 'Digits', 'fridominimal-core' ),
        ...
        $this->add_control(
            'heading_label',
            [
                'label' => __( 'Label', 'fridominimal-core' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months' => __( 'Months', 'fridominimal-core' ),
            'label_weeks' => __( 'Weeks', 'fridominimal-core' ),
            'label_days' => __( 'Days', 'fridominimal-core' ),
            'label_hours' => __( 'Hours', 'fridominimal-core' ),
            'label_minutes' => __( 'Minutes', 'fridominimal-core' ),
            'label_seconds' => __( 'Seconds', 'fridominimal-core' ),
        ];
    }
