...
class OSF_Elementor_Testimonials extends OSF_Elementor_Carousel_Base{
    ...
    public function get_title() {
        return __('Opal Testimonials', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => __('Testimonials', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'testimonials',
            [
                'label'       => __('Testimonials Item', 'fridominimal-core'),
...
//                'prefix_class' => 'elementor-testimonial-text-align-',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'layout_1',
                'options' => [
                    'layout_1'   => __('Layout 1', 'fridominimal-core'),
                    'layout_2'   => __('Layout 2', 'fridominimal-core'),
                    'layout_3'   => __('Layout 3', 'fridominimal-core'),
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'image_size',
            [
                'label'      => __('Image Size', 'fridominimal-core'),
