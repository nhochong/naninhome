...
class OSF_Elementor_Brand extends  OSF_Elementor_Carousel_Base{
    ...
    public function get_title() {
        return __( 'Opal Brands', 'fridominimal-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => __( 'Brands', 'fridominimal-core' ),
            ]
        );
        ...
        $this->add_control(
            'brands',
            [
                'label' => __( 'Brand Items', 'fridominimal-core' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => [
                    [
                        'name' => 'brand_title',
                        'label' => __( 'Brand name', 'fridominimal-core' ),
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Brand Name', 'fridominimal-core' ),
                        'placeholder' => __( 'Brand Name', 'fridominimal-core' ),
                        'label_block' => true,
                    ],
                    [
                        'name' => 'brand_image',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Carousel Options', 'fridominimal-core' ),
        ...
        $this->add_control(
            'enable_carousel',
            [
                'label' => __( 'Enable', 'fridominimal-core' ),
        ...
        $this->add_control(
            'navigation',
            [
                'label' => __( 'Navigation', 'fridominimal-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'both' => __( 'Arrows and Dots', 'fridominimal-core' ),
                    'arrows' => __( 'Arrows', 'fridominimal-core' ),
                    'dots' => __( 'Dots', 'fridominimal-core' ),
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label' => __( 'Pause on Hover', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay',
            [
                'label' => __( 'Autoplay', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => __( 'Autoplay Speed', 'fridominimal-core' ),
        ...
        $this->add_control(
            'infinite',
            [
                'label' => __( 'Infinite Loop', 'fridominimal-core' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
