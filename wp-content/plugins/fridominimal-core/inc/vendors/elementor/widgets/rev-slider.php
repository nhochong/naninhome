...
class OSF_Elementor_RevSlider extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __('Opal Revolution Slider', 'poeme-core');
	}
	...
	protected function _register_controls() {
		...
		if ( $arrSliders ) {
			...
			$revsliders[ 0 ] = __( 'No sliders found', 'poeme-core' );
		}

		$this->add_control(
			'rev_alias',
			[
				'label'   => __('Revolution Slider', 'poeme-core'),
