...
class OSF_Elementor_CallToAction extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Call to Action', 'fridominimal-core' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_main_image',
			[
				'label' => __( 'Image', 'fridominimal-core' ),
			]
		);
		...
		$this->add_control(
			'skin',
			[
				'label' => __( 'Skin', 'fridominimal-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'classic' => __( 'Classic', 'fridominimal-core' ),
					'cover' => __( 'Cover', 'fridominimal-core' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'above' => [
						'title' => __( 'Above', 'fridominimal-core' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Image Resolution', 'fridominimal-core' ),
				'default' => 'large',
				'condition' => [
					'bg_image[id]!' => '',
				],
		...
		$this->add_control(
			'graphic_element',
			[
				'label' => __( 'Graphic Element', 'fridominimal-core' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'none' => [
						'title' => __( 'None', 'fridominimal-core' ),
						'icon' => 'fa fa-ban',
					],
					'image' => [
						'title' => __( 'Image', 'fridominimal-core' ),
						'icon' => 'fa fa-picture-o',
					],
					'icon' => [
						'title' => __( 'Icon', 'fridominimal-core' ),
						'icon' => 'fa fa-star',
					],
				],
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'fridominimal-core' ),
		...
		$this->add_control(
			'link_click',
			[
				'label' => __( 'Apply Link On', 'fridominimal-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'box' => __( 'Whole Box', 'fridominimal-core' ),
					'button' => __( 'Button Only', 'fridominimal-core' ),
				],
				'default' => 'button',
				'separator' => 'none',
				'condition' => [
		...
		$this->start_controls_section(
			'box_style',
			[
				'label' => __( 'Box', 'fridominimal-core' ),
		...
		$this->add_responsive_control(
			'min-height',
			[
				'label' => __( 'Min. Height', 'fridominimal-core' ),
		...
		$this->add_responsive_control(
			'image_min_width',
			[
				'label' => __( 'Min. Width', 'fridominimal-core' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Opacity', 'fridominimal-core' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
		...
		$this->add_control(
			'icon_size',
			[
				'label' => __( 'Icon Size', 'fridominimal-core' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 6,
		...
		$this->add_control(
			'icon_padding',
			[
				'label' => __( 'Icon Padding', 'fridominimal-core' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'title_color',
			[
				'label' => __( 'Title Color', 'fridominimal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'description_color',
			[
				'label' => __( 'Description Color', 'fridominimal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_color',
			[
				'label' => __( 'Button Color', 'fridominimal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'fridominimal-core' ),
		...
		$this->start_controls_section(
			'hover_effects',
			[
				'label' => __( 'Hover Effects', 'fridominimal-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'groups' => [
					[
						'label' => __( 'None', 'fridominimal-core' ),
						'options' => [
							'' => __( 'None', 'fridominimal-core' ),
						],
					],
					[
						'label' => __( 'Entrance', 'fridominimal-core' ),
						'options' => [
					...
					[
						'label' => __( 'Reaction', 'fridominimal-core' ),
						'options' => [
							'grow' => 'Grow',
							'shrink' => 'Shrink',
					...
					[
						'label' => __( 'Exit', 'fridominimal-core' ),
						'options' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Animation Duration', 'fridominimal-core' ),
				'type' => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'default' => [
					'size' => 1000,
		...
		$this->add_control(
			'sequenced_animation',
			[
				'label' => __( 'Sequenced Animation', 'fridominimal-core' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => __( 'Background', 'fridominimal-core' ),
				'separator' => 'before',
				'condition' => [
					'skin' => 'cover',
				],
		...
		$this->add_control(
			'overlay_color',
			[
				'label' => __( 'Overlay Color', 'fridominimal-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'overlay_blend_mode',
			[
				'label' => __( 'Blend Mode', 'fridominimal-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Normal', 'fridominimal-core' ),
					'multiply' => 'Multiply',
					'screen' => 'Screen',
					'overlay' => 'Overlay',
					'darken' => 'Darken',
		...
		$this->add_control(
			'effect_duration',
			[
				'label' => __( 'Effect Duration', 'fridominimal-core' ),
				'type' => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'default' => [
					'size' => 1500,
