...
class OSF_Elementor_Search_Form extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Search Form', 'fridominimal-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'search_content',
            [
                'label' => __( 'Search Form', 'fridominimal-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'minimal' => __( 'Minimal', 'fridominimal-core' ),
                    'full_screen' => __( 'Full Screen', 'fridominimal-core' ),
                ],
        ...
        $this->add_control(
            'placeholder',
            [
                'label' => __( 'Placeholder', 'fridominimal-core' ),
                'type' => Controls_Manager::TEXT,
                'separator' => 'before',
                'default' => __( 'Search', 'fridominimal-core' ) . '...',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'icon',
                'options' => [
                    'icon' => __( 'Icon', 'fridominimal-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'search' => [
                        'title' => __( 'Search', 'fridominimal-core' ),
                        'icon' => 'fa fa-search',
                    ],
                    'arrow' => [
                        'title' => __( 'Arrow', 'fridominimal-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Toggle', 'fridominimal-core' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'skin' => 'full_screen',
        ...
        $this->start_controls_section(
            'section_input_style',
            [
                'label' => __( 'Input', 'fridominimal-core' ),
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => __( 'Focus', 'fridominimal-core' ),
            ]
        );
        ...
        $this->add_control(
            'button_border_width',
            [
                'label' => __( 'Border Size', 'fridominimal-core' ),
            ...
            <div class="elementor-search-form__container">
                ...
                <?php if ( 'full_screen' === $settings['skin'] ) : ?>
                    <div class="dialog-lightbox-close-button dialog-close-button">
                        ...
                        <span class="elementor-screen-only"><?php esc_html_e( 'Close', 'fridominimal-core' ); ?></span>
                    </div>
                <?php endif ?>
            </div>
        </form>
    ...
    protected function _content_template() {
        ...
        <form class="elementor-search-form" action="" role="search">
            ...
            <div class="elementor-search-form__container">
                ...
                <input type="search"
                       name="s"
                       title="<?php esc_attr_e( 'Search', 'fridominimal-core' ); ?>"
                       class="elementor-search-form__input"
                       placeholder="{{ settings.placeholder }}">
