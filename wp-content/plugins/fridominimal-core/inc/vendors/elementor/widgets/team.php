...
class OSF_Elementor_Team extends OSF_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return __('Opal Teams', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_team',
            [
                'label' => __('Teams', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'options',
            [
                'label'   => __('Additional Options', 'fridominimal-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Information', 'fridominimal-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
