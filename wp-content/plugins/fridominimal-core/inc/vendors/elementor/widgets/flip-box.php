...
class OSF_Elementor_Flip_Box extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Flip Box', 'fridominimal-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'fridominimal-core' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'fridominimal-core' ) ] );
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'fridominimal-core' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay', 'fridominimal-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'fridominimal-core' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'fridominimal-core' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'fridominimal-core' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'fridominimal-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'fridominimal-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => __( 'Left', 'fridominimal-core' ),
					'right' => __( 'Right', 'fridominimal-core' ),
					'up' => __( 'Up', 'fridominimal-core' ),
					'down' => __( 'Down', 'fridominimal-core' ),
				],
				'condition' => [
					'flip_effect!' => [
							'fade',
		...
		$this->add_control(
			'flip_3d',
			[
				'label' => __( '3D Depth', 'fridominimal-core' ),
		...
		$this->add_control(
			'icon_rotate',
			[
				'label' => __( 'Icon Rotate', 'fridominimal-core' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
