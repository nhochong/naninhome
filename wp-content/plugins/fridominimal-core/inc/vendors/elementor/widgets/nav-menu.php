...
class OSF_Elementor_Nav_Menu extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Nav Menu', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        ...
        if (!empty($menus)) {
            $this->add_control(
                'menu',
                [
                    'label'        => __('Menu', 'fridominimal-core'),
                    'type'         => Controls_Manager::SELECT,
                    'options'      => $menus,
                    'default'      => array_keys($menus)[0],
                    'save_default' => true,
                    'separator'    => 'after',
                    'description'  => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'fridominimal-core'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'fridominimal-core'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator'       => 'after',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'            => 'horizontal',
                'options'            => [
                    'horizontal' => __('Horizontal', 'fridominimal-core'),
                    'vertical'   => __('Vertical', 'fridominimal-core'),
                    'dropdown'   => __('Dropdown', 'fridominimal-core'),
                ],
        ...
        $this->add_control(
            'align_items',
            [
                'label'        => __('Align', 'fridominimal-core'),
                ...
                'options'      => [
                    ...
                    'justify' => [
                        'title' => __('Stretch', 'fridominimal-core'),
        ...
        $this->add_control(
            'pointer',
            [
                'label'     => __('Pointer', 'fridominimal-core'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'underline',
                'options'   => [
                    'none'        => __('None', 'fridominimal-core'),
                    'underline'   => __('Underline', 'fridominimal-core'),
                    'overline'    => __('Overline', 'fridominimal-core'),
                    'double-line' => __('Double Line', 'fridominimal-core'),
                    'framed'      => __('Framed', 'fridominimal-core'),
                    'background'  => __('Background', 'fridominimal-core'),
                    'text'        => __('Text', 'fridominimal-core'),
                    'dot'         => __('Dot', 'fridominimal-core'),
                ],
                'condition' => [
                    'layout!' => 'dropdown',
                ],
        ...
        $this->add_control(
            'indicator',
            [
                'label'        => __('Submenu Indicator', 'fridominimal-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'classic',
                'options'      => [
                    'none'    => __('None', 'fridominimal-core'),
                    'classic' => __('Classic', 'fridominimal-core'),
                    'chevron' => __('Chevron', 'fridominimal-core'),
                    'angle'   => __('Angle', 'fridominimal-core'),
                    'plus'    => __('Plus', 'fridominimal-core'),
                ],
        ...
        $this->add_responsive_control(
            'subMenusMinWidth',
            [
                'label'     => __('Min width Submenu(px)', 'fridominimal-core'),
        ...
        $this->add_responsive_control(
            'subMenusMaxWidth',
            [
                'label'     => __('Max width Submenu(px)', 'fridominimal-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Mobile Dropdown', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Enable Mobile Menu', 'fridominimal-core'),
        ...
        $this->add_control(
            'dropdown',
            [
                'label'        => __('Breakpoint', 'fridominimal-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'tablet',
                'options'      => [
                    'mobile' => __('Mobile (767px >)', 'fridominimal-core'),
                    'tablet' => __('Tablet (1023px >)', 'fridominimal-core'),
                ],
        ...
        $this->add_control(
            'full_width',
            [
                'label'              => __('Full Width', 'fridominimal-core'),
                'type'               => Controls_Manager::SWITCHER,
                'description'        => __('Stretch the dropdown of the menu to full width.', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'aside',
                'options'      => [
                    'aside'  => __('Aside', 'fridominimal-core'),
                    'center' => __('Center', 'fridominimal-core'),
                ],
        ...
        $this->add_control(
            'toggle',
            [
                'label'              => __('Toggle Button', 'fridominimal-core'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'burger',
                'options'            => [
                    ''       => __('None', 'fridominimal-core'),
                    'burger' => __('Hamburger', 'fridominimal-core'),
                ],
        ...
        $this->add_control(
            'toggle_align',
            [
                'label'                => __('Toggle Align', 'fridominimal-core'),
                'type'                 => Controls_Manager::CHOOSE,
                'default'              => 'center',
                'options'              => [
                    'left'   => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Main Menu', 'fridominimal-core'),
        ...
        $this->add_control(
            'enable_divider',
            [
                'label'     => __('Enable Divider', 'fridominimal-core'),
                'type'      => Controls_Manager::SWITCHER,
                'condition' => [
                    'layout' => 'horizontal',
                ],
        ...
        $this->add_control(
            'color_divider',
            [
                'label'     => __('Divider Color', 'fridominimal-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_3,
        ...
        $this->add_responsive_control(
            'height_divider',
            [
                'label'     => __('Divider Padding', 'fridominimal-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Pointer Color', 'fridominimal-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_4,
        ...
        $this->add_control(
            'pointer_width',
            [
                'label'     => __('Pointer Width', 'fridominimal-core'),
                'type'      => Controls_Manager::SLIDER,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Horizontal Padding', 'fridominimal-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Vertical Padding', 'fridominimal-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Dropdown', 'fridominimal-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'enable_mobile_dropdown' => 'yes'
                ],
        ...
        $this->add_control(
            ...
            [
                'raw'             => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'fridominimal-core'),
                'type'            => Controls_Manager::RAW_HTML,
