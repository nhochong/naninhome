...
class OSF_Elementor_Price_Table extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Price Table', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_header',
            [
                'label' => __('Header', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Pricing Table', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'sub_heading',
            [
                'label' => __('Subtitle', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('I am subtitle', 'fridominimal-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_pricing',
            [
                'label' => __('Pricing', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'currency_symbol',
            [
                'label' => __('Currency Symbol', 'fridominimal-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => __('None', 'fridominimal-core'),
                    'dollar' => '&#36; ' . _x('Dollar', 'Currency Symbol', 'fridominimal-core'),
                    'euro' => '&#128; ' . _x('Euro', 'Currency Symbol', 'fridominimal-core'),
                    'baht' => '&#3647; ' . _x('Baht', 'Currency Symbol', 'fridominimal-core'),
                    'franc' => '&#8355; ' . _x('Franc', 'Currency Symbol', 'fridominimal-core'),
                    'guilder' => '&fnof; ' . _x('Guilder', 'Currency Symbol', 'fridominimal-core'),
                    'krona' => 'kr ' . _x('Krona', 'Currency Symbol', 'fridominimal-core'),
                    'lira' => '&#8356; ' . _x('Lira', 'Currency Symbol', 'fridominimal-core'),
                    'peseta' => '&#8359 ' . _x('Peseta', 'Currency Symbol', 'fridominimal-core'),
                    'peso' => '&#8369; ' . _x('Peso', 'Currency Symbol', 'fridominimal-core'),
                    'pound' => '&#163; ' . _x('Pound Sterling', 'Currency Symbol', 'fridominimal-core'),
                    'real' => 'R$ ' . _x('Real', 'Currency Symbol', 'fridominimal-core'),
                    'ruble' => '&#8381; ' . _x('Ruble', 'Currency Symbol', 'fridominimal-core'),
                    'rupee' => '&#8360; ' . _x('Rupee', 'Currency Symbol', 'fridominimal-core'),
                    'indian_rupee' => '&#8377; ' . _x('Rupee (Indian)', 'Currency Symbol', 'fridominimal-core'),
                    'shekel' => '&#8362; ' . _x('Shekel', 'Currency Symbol', 'fridominimal-core'),
                    'yen' => '&#165; ' . _x('Yen/Yuan', 'Currency Symbol', 'fridominimal-core'),
                    'won' => '&#8361; ' . _x('Won', 'Currency Symbol', 'fridominimal-core'),
                    'custom' => __('Custom', 'fridominimal-core'),
                ],
                'default' => 'dollar',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Custom Symbol', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->add_control(
            'price',
            [
                'label' => __('Price', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'default' => '39.99',
            ]
        );
        ...
        $this->add_control(
            'currency_format',
            [
                'label' => __('Currency Format', 'fridominimal-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => '1,234.56 (Default)',
                    ',' => '1.234,56',
        ...
        $this->add_control(
            'sale',
            [
                'label' => __('Sale', 'fridominimal-core'),
        ...
        $this->add_control(
            'original_price',
            [
                'label' => __('Original Price', 'fridominimal-core'),
        ...
        $this->add_control(
            'period',
            [
                'label' => __('Period', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Monthly', 'fridominimal-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_features',
            [
                'label' => __('Features', 'fridominimal-core'),
            ]
        );
        ...
        $repeater->add_control(
            'item_text',
            [
                'label' => __('Text', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('List Item', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'item_text' => __('List Item #1', 'fridominimal-core'),
                        'item_icon' => 'fa fa-check-circle',
                    ],
                    [
                        'item_text' => __('List Item #2', 'fridominimal-core'),
                        'item_icon' => 'fa fa-check-circle',
                    ],
                    [
                        'item_text' => __('List Item #3', 'fridominimal-core'),
                        'item_icon' => 'fa fa-check-circle',
                    ],
                ],
        ...
        $this->start_controls_section(
            'section_footer',
            [
                'label' => __('Footer', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'button_text',
            [
                'label' => __('Button Text', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Click Here', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'link',
            [
                'label' => __('Link', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Additional Info', 'fridominimal-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('This is text element', 'fridominimal-core'),
                'rows' => 2,
            ]
        );
        ...
        $this->start_controls_section(
            'section_ribbon',
            [
                'label' => __('Ribbon', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            'show_ribbon',
            [
                'label' => __('Show', 'fridominimal-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Title', 'fridominimal-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Popular', 'fridominimal-core'),
                'condition' => [
                    'show_ribbon' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Horizontal Position', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Sub Title', 'fridominimal-core'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Vertical Position', 'fridominimal-core'),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
                    ...
                    'middle' => [
                        'title' => __('Middle', 'fridominimal-core'),
                        'icon' => 'eicon-v-align-middle',
                    ],
                    'bottom' => [
                        'title' => __('Bottom', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Fractional Part', 'fridominimal-core'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'period_position',
            [
                'label' => __('Position', 'fridominimal-core'),
                'type' => Controls_Manager::SELECT,
                'label_block' => false,
                'options' => [
                    'below' => 'Below',
        ...
        $this->add_responsive_control(
            'item_width',
            [
                'label' => __('Width', 'fridominimal-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '%' => [
                        'min' => 25,
        ...
        $this->add_control(
            'list_divider',
            [
                'label' => __('Divider', 'fridominimal-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'solid' => __('Solid', 'fridominimal-core'),
                    'double' => __('Double', 'fridominimal-core'),
                    'dotted' => __('Dotted', 'fridominimal-core'),
                    'dashed' => __('Dashed', 'fridominimal-core'),
                ],
                'default' => 'solid',
                'condition' => [
                    'list_divider' => 'yes',
        ...
        $this->add_control(
            'divider_weight',
            [
                'label' => __('Weight', 'fridominimal-core'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 2,
                    'unit' => 'px',
        ...
        $this->add_control(
            'divider_gap',
            [
                'label' => __('Gap', 'fridominimal-core'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                    'unit' => 'px',
        ...
        $this->add_control(
            'freatures_boder',
            [
                'label' => __('Boder', 'fridominimal-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Button', 'fridominimal-core'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'button_text!' => '',
        ...
        $this->add_control(
            'button_text_padding',
            [
                'label' => __('Text Padding', 'fridominimal-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Border Color', 'fridominimal-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Animation', 'fridominimal-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Margin', 'fridominimal-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'default' => [
                    'top' => 15,
        ...
        $this->add_responsive_control(
            'ribbon_distance',
            [
                'label' => __('Distance', 'fridominimal-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
