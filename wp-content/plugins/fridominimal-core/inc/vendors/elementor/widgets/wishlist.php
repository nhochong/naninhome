...
class OSF_Elementor_Wishlist extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Wishlist', 'fridominimal-core' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'cart_content',
			[
				'label' => __( 'WooCommerce Wishlist', 'fridominimal-core' ),
			]
		);
		...
		$this->add_control(
			'show_subtotal',
			[
				'label'       => __('Show Total', 'fridominimal-core'),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'View wishlist ', 'fridominimal-core' ),
				'label_block' => true,
			]
		);
