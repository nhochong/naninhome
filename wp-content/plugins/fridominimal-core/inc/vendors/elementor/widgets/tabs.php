...
class OSF_Elementor_Tabs extends  Elementor\Widget_Base{
    ...
    public function get_title() {
        return __( 'Opal Tabs', 'fridominimal-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_tabs',
            [
                'label' => __( 'Tabs', 'fridominimal-core' ),
            ]
        );
        ...
        $this->add_control(
            'tabs',
            [
                'label' => __( 'Tabs Items', 'fridominimal-core' ),
                'type' => Controls_Manager::REPEATER,
                'default' => [
                    [
                        'tab_title' => __( 'Tab #1', 'fridominimal-core' ),
                        'source' => 'html',
                        'tab_html' => __( 'I am tab content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'fridominimal-core' ),
                    ],
                    [
                        'tab_title' => __( 'Tab #2', 'fridominimal-core' ),
                        'source' => 'html',
                        'tab_html' => __( 'I am tab content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'fridominimal-core' ),
                    ],
                ],
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Title & Content', 'fridominimal-core' ),
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Tab Title', 'fridominimal-core' ),
                        'placeholder' => __( 'Tab Title', 'fridominimal-core' ),
                        'label_block' => true,
                    ],
                    [
                        'name' => 'source',
                        'label' => __( 'Source', 'fridominimal-core' ),
                        'type' => Controls_Manager::SELECT,
                        'default' => 'html',
                        'options' => [
                            'html' => __( 'HTML', 'fridominimal-core' ),
                            'template' => __( 'Template', 'fridominimal-core' ),
                        ],
                    ],
                    [
                        'name' => 'tab_html',
                        'label' => __( 'Content', 'fridominimal-core' ),
                        'default' => __( 'Tab Content', 'fridominimal-core' ),
                        'placeholder' => __( 'Tab Content', 'fridominimal-core' ),
                    ...
                    [
                        'name' => 'tab_template',
                        'label' => __( 'Choose Template', 'fridominimal-core' ),
                        'default' => 0,
                        'type' => Controls_Manager::SELECT,
                        'options' => $options,
                        'types' => $types,
        ...
        $this->add_control(
            'type',
            [
                'label' => __( 'Type', 'fridominimal-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'horizontal',
                'options' => [
        ...
        $this->add_control(
            'navigation_width',
            [
                'label' => __( 'Navigation Width', 'fridominimal-core' ),
        ...
        $this->add_control(
            'tab_active_color',
            [
                'label' => __( 'Active Color', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background Color Active', 'fridominimal-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
