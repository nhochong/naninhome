...
class OSF_Element_Social_Share extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Social Share', 'fridominimal-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Share Buttons', 'fridominimal-core' ),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label' => __( 'Select Socials', 'fridominimal-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'gradient' => __( 'Gradient', 'fridominimal-core' ),
                    'minimal' => __( 'Minimal', 'fridominimal-core' ),
                    'framed' => __( 'Framed', 'fridominimal-core' ),
                    'boxed' => __( 'Boxed Icon', 'fridominimal-core' ),
                    'flat' => __( 'Flat', 'fridominimal-core' ),
                ],
                'default' => 'gradient',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'rounded' => __( 'Rounded', 'fridominimal-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'justify' => [
                        'title' => __( 'Justify', 'fridominimal-core' ),
        ...
        $this->add_responsive_control(
            'column_gap',
            [
                'label'     => __( 'Columns Gap', 'fridominimal-core' ),
        ...
        $this->add_responsive_control(
            'row_gap',
            [
                'label'     => __( 'Rows Gap', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label' => __( 'Button Size', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label' => __( 'Button Height', 'fridominimal-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'em' => [
                        'min' => 1,
            ...
            <?php foreach ( $settings['socials'] as $button ) {
                ...
                <div class="elementor-grid-item">
                    <div class="elementor-share-btn">
                        <a href="<?php $this->render_html_social($button); ?>" target="_blank" title="<?php printf( __('Share on %s', 'fridominimal-core'), $title)?>">
