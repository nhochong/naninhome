...
class OSF_Elementor_Metadata extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Portfolio Metadata', 'fridominimal-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_metadata',
            [
                'label' => __('Data', 'fridominimal-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'vertical',
                'options' => array(
                    'horizontal' => esc_html__('Horizontal', 'fridominimal-core'),
                    'vertical' => esc_html__('Vertical', 'fridominimal-core'),
                ),
            ]
        );
        ...
        $this->add_control(
            'data',
            [
                'label'       => __('Meta Item', 'fridominimal-core'),
                ...
                'fields'      => [
                    ...
                    [
                        'name'    => 'value',
                        'label'   => __('Value', 'fridominimal-core'),
                        'default' => 'Google',
                        'type'    => Controls_Manager::TEXT,
                    ],
                ],
