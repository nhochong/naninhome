...
final class CEI_Core {
    ...
    static public function controls_enqueue_scripts() {
        ...
        wp_localize_script( 'cei-js', 'CEIl10n', array(
            'emptyImport' => __( 'Please choose a file to import.', 'fridominimal-core' ),
        ) );
    ...
    static public function register($wp_customize) {
        ...
        $wp_customize->add_section( 'cei-section', array(
            'title'    => __( 'Export/Import', 'fridominimal-core' ),
            'priority' => 10000000,
        ) );
    ...
    static private function _export_all($wp_customize) {
        ...
        $mods     = get_theme_mods();
        $data     = array(
            'template' => apply_filters( 'osf_customize_export_template_name', $template ),
    ...
    static private function _import($wp_customize) {
        ...
        if (!file_exists( $file['file'] )){
            $cei_error = __( 'Error importing settings! Please try again.', 'fridominimal-core' );
        ...
        if ('array' != gettype( $data )){
            $cei_error = __( 'Error importing settings! Please check that you uploaded a customizer export file.', 'fridominimal-core' );
