...
class OSF_Customize {
    ...
    public function customize_register($wp_customize) {
        ...
        $this->link_image   = trailingslashit( FRIDOMINIMAL_CORE_PLUGIN_URL ) . 'assets/images/customize/';
    ...
    public function init_osf_colors($wp_customize){
        ...
        $wp_customize->add_section( 'osf_colors_header', array(
            'title'          => __( 'Header' ),
            'capability'     => 'edit_theme_options',
            'panel'          => 'osf_colors', 
            'priority'       => 1, 
        ...
        if(class_exists('OSF_Customize_Control_Button_Group')){
            $wp_customize->add_setting( 'osf_colors_header_skin', array(
                'default'           => 'light',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'sanitize_text_field',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Group( $wp_customize, 'osf_colors_header_skin', array(
                'section' => 'osf_colors_header',
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_header_bg', array(
                'default'           => '#fff',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_header_bg', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Background Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_header_bg', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_header_color', array(
                'default'           => '#000',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_header_color', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_header_color', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_mainmenu', array(
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_mainmenu', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Main Menu Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_mainmenu', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_topbar_bg', array(
                'default'           => '#ddd',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_topbar_bg', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Topbar Background Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_topbar_bg', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_topbar_color', array(
                'default'           => '#222',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_topbar_color', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Topbar Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_topbar_color', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Button_Group')){
            $wp_customize->add_setting( 'osf_colors_header_sticky_skin', array(
                'default'           => 'light',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'sanitize_text_field',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Group( $wp_customize, 'osf_colors_header_sticky_skin', array(
                'section' => 'osf_colors_header',
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_header_sticky_bg', array(
                'default'           => '#fff',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_header_sticky_bg', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Background Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_header_sticky_bg', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_header_sticky_color', array(
                'default'           => '#000',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_header_sticky_color', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_header_sticky_color', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Color')){
            $wp_customize->add_setting( 'osf_colors_mainmenu_sticky', array(
                'transport'         => 'postMessage',
                'sanitize_callback' => 'maybe_hash_hex_color',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Color( $wp_customize, 'osf_colors_mainmenu_sticky', array(
                'section' => 'osf_colors_header',
                'label' => __( 'Main Menu Color' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_colors_mainmenu_sticky', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
        
        if(class_exists('OSF_Customize_Control_Button_Move')){
            $wp_customize->add_setting( 'osf_colors_header_button_move', array(
                'sanitize_callback' => 'sanitize_text_field',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Move( $wp_customize, 'osf_colors_header_button_move', array(
                'section' => 'osf_colors_header',
                'buttons'  => array(
                'osf_header' => array(
                    'type'  => 'section',
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Heading')){
            $wp_customize->add_setting( 'osf_colors_page_title_bg_titlfdfdasfe', array(
                'sanitize_callback' => 'sanitize_text_field',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Heading( $wp_customize, 'osf_colors_page_title_bg_titlfdfdasfe', array(
    ...
    public function init_osf_header($wp_customize){
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Button_Switch')){
            $wp_customize->add_setting( 'osf_header_layout_enable_cart_in_menu', array(
                'default'           => 'true',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'osf_sanitize_button_switch',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Switch( $wp_customize, 'osf_header_layout_enable_cart_in_menu', array(
                'section' => 'osf_header',
                'label' => __( 'Enable Cart' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_header_layout_enable_cart_in_menu', array(
            'selector'        => '#masthead',
            'render_callback' => 'osf_customize_partial_header_content',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Button_Switch')){
            $wp_customize->add_setting( 'osf_header_layout_enable_search_form_in_menu', array(
                'default'           => 'true',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'osf_sanitize_button_switch',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Switch( $wp_customize, 'osf_header_layout_enable_search_form_in_menu', array(
                'section' => 'osf_header',
                'label' => __( 'Enable Search Form' ),
            ) ) );
        }

        $wp_customize->selective_refresh->add_partial( 'osf_header_layout_enable_search_form_in_menu', array(
            'selector'        => '#masthead',
            'render_callback' => 'osf_customize_partial_header_content',
        ) );
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Button_Switch')){
            $wp_customize->add_setting( 'osf_header_layout_is_sticky', array(
                'sanitize_callback' => 'osf_sanitize_button_switch',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Switch( $wp_customize, 'osf_header_layout_is_sticky', array(
                'section' => 'osf_header',
        ...
        // =========================================
            $wp_customize->add_setting( 'osf_header_layout_sticky_layout', array(
                'default'           => '1',
                'sanitize_callback' => 'sanitize_text_field',
            ) );
        $wp_customize->add_control( 'osf_header_layout_sticky_layout', array(
            'section' => 'osf_header',
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Button_Switch')){
            $wp_customize->add_setting( 'osf_header_layout_sticky_full_width', array(
                'sanitize_callback' => 'osf_sanitize_button_switch',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Switch( $wp_customize, 'osf_header_layout_sticky_full_width', array(
                'section' => 'osf_header',
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Button_Switch')){
            $wp_customize->add_setting( 'osf_header_layout_enable_side_header', array(
                'transport'         => 'postMessage',
                'sanitize_callback' => 'osf_sanitize_button_switch',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Switch( $wp_customize, 'osf_header_layout_enable_side_header', array(
                'section' => 'osf_header',
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Button_Group')){
            $wp_customize->add_setting( 'osf_header_layout_side_header_position', array(
                'default'           => 'left',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'sanitize_text_field',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Button_Group( $wp_customize, 'osf_header_layout_side_header_position', array(
                'section' => 'osf_header',
        ...
        // =========================================
        if(class_exists('OSF_Customize_Control_Slider')){
            $wp_customize->add_setting( 'osf_header_layout_side_header_width', array(
                'default'           => '300',
                'transport'         => 'postMessage',
                'sanitize_callback' => 'sanitize_text_field',
            ) );
            $wp_customize->add_control( new OSF_Customize_Control_Slider( $wp_customize, 'osf_header_layout_side_header_width', array(
                'section' => 'osf_header',
        ...
        $wp_customize->selective_refresh->add_partial( 'osf_header_layout_side_header_width', array(
            'selector'        => '#osf-style-inline-css-customizer',
            'render_callback' => 'osf_customize_partial_css',
        ) );
