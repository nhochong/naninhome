...
//    $content = get_transient('osf_list_google_fonts_new');
//    if (!$content) {
//        $content = file_get_contents(FRIDOMINIMAL_CORE_PLUGIN_DIR . 'webfonts.json');
//        set_transient('osf_list_google_fonts_new', $content, WEEK_IN_SECONDS);
//    }
